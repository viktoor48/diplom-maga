...
<template>
  <RangeCalendarRoot v-slot="{ grid, weekDays }" :class="cn('p-3', props.class)" v-bind="forwarded">
    <RangeCalendarHeader :class="'calendar_header'">
      <RangeCalendarPrevButton :class="'prev_btn'" />
      <RangeCalendarHeading :class="'calendar_title'" />
      <RangeCalendarNextButton :class="'next_btn'" />
    </RangeCalendarHeader>
